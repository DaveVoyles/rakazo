...
export class DockerSandboxProvider implements SandboxProvider {
  ...
  // Team Computer screens are now keyed by x-rakazo-screen-id (see the
  // multi-screen supervisor work), distinct from the lease that gates who
  // may drive a screen. observe() still opts out of the lease header (see
  // includeScreenLease below): screen VIEWING stays shared regardless of
  // who currently holds the execution lease.
  private headers(
